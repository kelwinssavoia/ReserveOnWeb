<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastroEmpresa.aspx.cs" Inherits="ReserveOnWeb.Administrador.CadastroEmpresa" MasterPageFile="~/ReserveOn.Master"%>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        required="required" data-validation-required-message="Por favor entre com o Usuário." MaxLength="10" OnTextChanged="txtUsuario_TextChanged" AutoPostBack="true">
                        </asp:TextBox>
                    </td>
                    <td>
                        <label>Email: </label>
